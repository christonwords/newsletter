...
use `play` to audition an uploaded preview, or `remove` to delete it from the site.
with `commit and push after export` checked, removals are committed and pushed too.
